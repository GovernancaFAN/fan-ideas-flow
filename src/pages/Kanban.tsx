...
const columns: { key: IdeaStatus[]; title: string; tone: string }[] = [
  { key: ["Pendente"], title: "Pendente", tone: "from-muted to-muted" },
  { key: ["Em análise", "Necessário novo entendimento"], title: "Em análise", tone: "from-info/20 to-info/5" },
  { key: ["Aprovado", "Em execução"], title: "Em execução", tone: "from-primary/30 to-primary/5" },
  { key: ["Concluído"], title: "Concluído", tone: "from-success/30 to-success/5" },
  { key: ["Reprovado"], title: "Reprovado", tone: "from-destructive/20 to-destructive/5" },
];
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="flex flex-wrap items-end justify-between gap-3 mb-6">
        <div>
          <h1 className="font-display text-3xl font-bold">Kanban de ideias</h1>
          <p className="text-sm text-muted-foreground">Visualize o fluxo das ideias em todas as etapas.</p>
        </div>
